            ...
            <span className="text-blue-100 flex flex-col p-2">
              ...
              <div>
                <input
                  ...
                  id="device1"
                  value="PC"
                  checked={formData.devices.includes("PC")}
              ...
              <div>
                <input
                  ...
                  id="device2"
                  value="PS4"
                  checked={formData.devices.includes("PS4")}
                  onChange={handleDeviceChange}
                />{" "}
                Play Station 4
              </div>
              <div>
                <input
                  ...
                  id="device3"
                  value="PS5"
                  checked={formData.devices.includes("PS5")}
                  onChange={handleDeviceChange}
                />{" "}
                Play Station 5
              </div>
              <div>
                ...
                <input
                  ...
                  id="device4"
                  value="Xbox 3"
                  checked={formData.devices.includes("Xbox 3")}
                  onChange={handleDeviceChange}
                />{" "}
                Xbox 3
              </div>
              <div>
                ...
                <input
                  ...
                  id="device5"
                  value="Android OS"
                  checked={formData.devices.includes("Android OS")}
                  onChange={handleDeviceChange}
                />{" "}
                Android OS
              </div>
              <div>
                <input
                  ...
                  id="device6"
                  value="iOS"
                  checked={formData.devices.includes("iOS")}
                  onChange={handleDeviceChange}
                />{" "}
                iOS
              </div>
